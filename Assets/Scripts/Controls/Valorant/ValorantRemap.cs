...
public class ValorantRemap : MonoBehaviour
{
    ...
    {
        settings = sett;
        //rebinds = (ValorantRebinds)settings.rebinds;
    ...
    public void Remap(int actionNumber)
    {
        ...
        {
            case 1:
                RemapLogic(settings.controlls.ValorantControl.MnKCrouch, settings.controlls.UIControl.MnKCrouch, MnKTextFiedls[0], AllSettingsKeys.CROUCH);
                break;
            case 2:
                RemapLogic(settings.controlls.ValorantControl.MnKJump, settings.controlls.UIControl.MnKJump, MnKTextFiedls[1], AllSettingsKeys.JUMP);
                break;
            case 3:
                RemapLogic(settings.controlls.ValorantControl.MnKFire, settings.controlls.UIControl.MnKFire, MnKTextFiedls[2], AllSettingsKeys.FIRE);
                break;
            case 4:
                RemapLogic(settings.controlls.ValorantControl.MnKAds, settings.controlls.UIControl.MnKAds, MnKTextFiedls[3], AllSettingsKeys.ADS);
                break;
            case 5:
                RemapLogic(settings.controlls.ValorantControl.MnKUse, settings.controlls.UIControl.MnKUse, MnKTextFiedls[4], AllSettingsKeys.USE);
                break;
        }
    }
